          ...
          <div className="ins-banner-body">
            <Container fluid="xxl">
              <div className="ins-banner-hd">
                <h1>
                  <span className="first-word">Privacy Policy</span>
                </h1>
              ...
              <div className="terms-cover">
                <div className="terms-item">
                  <p>
                    ...
                    You use the service and about your privacy rights and how
                  ...
                  <p>
                    ...
                    Policy. This Privacy Policy applies in addition to the Terms
                    and Conditions of our Site.
                  </p>
                  <p>
                    By using our Site, You agree to consent to the conditions
                ...
                <div className="terms-item">
                  ...
                  <p>
                    ...
                    "Our" in this Agreement) refers to Atria Accounting
                    Professional Corporation , 4 Robert Speck Parkway, Suite
                    1500, Mississauga, Ontario, L4Z 1S1.
                  </p>
                  ...
                  <p>
                    Website refers to Atria Accounting, accessible from
                    <Link href="http://debtsolutionsgroup.ca/">
                      www.debtsolutionsgroup.ca
                    </Link>
                  </p>
                  <p>
                ...
                <div className="terms-item">
                  <div className="terms-hd">
                    <h4>Collection of Personal Information and Data</h4>
                  </div>
                  ...
                  <p>
                    This data may be collected through a form, voluntarily
                    submitted by You.
                  </p>
                  <h4>Use of Your Personal Data</h4>
                  <p>
                    Data collected on our Site will only be used for the
                    purposes in this Privacy Policy or indicated on the relevant
                    pages of our Site. The Company may use Personal Data for the
                    following purposes:
                  </p>
                  <p>
                    To provide and maintain our Service, including to monitor
                    the usage of our Service. To contact You: To contact You by
                    ...
                    to us. For other purposes: We may use your information for
                  ...
                  <ul>
                    ...
                    <li>
                      Employees: We may share your information with any member
                      of our organization who reasonably needs access to user
                      data for purposes indicated in this Privacy Policy.
                    </li>
                    <li>
                ...
                <div className="terms-item">
                  ...
                  <p>
                    ...
                    maintained on — computers located outside of your, province,
                ...
                <div className="terms-item">
                  ...
                  <p>
                    ...
                    information about You from within the Service. You may also
                    contact s to request access to, correct, or delete any
                    personal information that You have provided to Us. Please
                ...
                <div className="terms-item">
                  ...
                  <p>
                    In order to protect your security, we store all of our data
                    on secure storage or server facilities. All data is only
                    accessible by select employees, who are bound by strict
